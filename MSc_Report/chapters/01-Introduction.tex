...
\begin{enumerate}
    \item \textbf{Decay (RQ1)}: Do projection differences computed from the base model remain a good predictor of future behaviour under a sequential fine-tuning setting? We also asked the following sub-question:
    \begin{enumerate}
